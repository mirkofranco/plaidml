...
def plaidml_workspace():
    ...
    # TODO: When gmock is updated, see if its LICENSE file has been exported;
    #       if it has, delete //bzl:googletest.LICENSE, and modify downstream dependents to
    #       pull the license directly from the gmock release.
    http_archive(
        name = "gmock",
